...
class MainActivity : AppCompatActivity() {
    //Lines for view binding
    //(1) lateinit is a keyword that promises that this variable will be initialized before use, else app will crash
    private lateinit var binding: ActivityMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //(2) initializing the binding object
    ...
    private fun calculateTip()
    {
        ...
        //Number formatter used to format numbers as currency
